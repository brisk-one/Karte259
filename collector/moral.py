...
def moral_type(settings):
    """Moraltyp aus get_config: 0 keine, 1 nach Punkten, 2 nach Punkten und Zeit, 3 zeitlich begrenzt
    nach Punkten (Welt 259 meldet 3, bestätigt über die Welteinstellungen). None, wenn unbekannt."""
    try:
